        ...
        <div className="">
          ...
          <div className="grid lg:grid-cols-5 gap-4">
            ...
            <motion.div
              ...
              {...fadeUp(0.1)}
            >
              <div className="rounded-2xl bg-linear-to-br from-[#4f46e5] via-[#7c3aed] to-[#a855f7] p-4 lg:p-8 text-white h-full flex flex-col justify-between">
                <div>
            ...
            <motion.div className="lg:col-span-3" {...fadeUp(0.2)}>
              <div className="bg-white shadow-xl shadow-black/5 p-4 lg:p-8 h-full rounded-2xl">
                {submitted ? (
