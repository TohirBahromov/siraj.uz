...
let PublicCategoriesController = class PublicCategoriesController {
    ...
    findTree(locale, leafOnly) {
        return this.categoriesService.findTree(locale?.trim() || 'uz', leafOnly === 'true');
    }
    getProducts(slug, locale, cursor, limit) {
        return this.categoriesService.findProductsBySlug(slug, locale?.trim() || 'uz', cursor ? Number(cursor) : undefined, limit ? Math.min(Number(limit), 50) : 10);
    }
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('leafOnly')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], PublicCategoriesController.prototype, "findTree", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PublicCategoriesController.prototype, "getProducts", null);
__decorate([
    (0, common_1.Get)(':slug'),
    __param(0, (0, common_1.Param)('slug')),
    __param(1, (0, common_1.Query)('locale')),
